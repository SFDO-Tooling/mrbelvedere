...
urlpatterns = patterns('',
    ...
    url(r'^repo/(?P<slug>\w+)/version/beta/tag', 'mrbelvedere.views.latest_beta_version_tag'),
    url(r'^repo/(?P<slug>\w+)/version/tag', 'mrbelvedere.views.latest_prod_version_tag'),
