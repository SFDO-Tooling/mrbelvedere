...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PullRequest.last_build_head_sha'
        db.add_column(u'mrbelvedere_pullrequest', 'last_build_head_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PullRequest.last_build_base_sha'
        db.add_column(u'mrbelvedere_pullrequest', 'last_build_base_sha',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PullRequest.last_build_head_sha'
        db.delete_column(u'mrbelvedere_pullrequest', 'last_build_head_sha')

        # Deleting field 'PullRequest.last_build_base_sha'
        db.delete_column(u'mrbelvedere_pullrequest', 'last_build_base_sha')
    ...
    models = {
        ...
        u'mrbelvedere.pullrequest': {
            ...
            'base_sha': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'github_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mrbelvedere.GithubUser']"}),
            'head_sha': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_build_base_sha': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'last_build_head_sha': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
