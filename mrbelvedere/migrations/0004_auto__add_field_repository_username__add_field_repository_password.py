...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Repository.username'
        db.add_column(u'mrbelvedere_repository', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Repository.password'
        db.add_column(u'mrbelvedere_repository', 'password',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Repository.username'
        db.delete_column(u'mrbelvedere_repository', 'username')

        # Deleting field 'Repository.password'
        db.delete_column(u'mrbelvedere_repository', 'password')
