...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PullRequest.head_sha'
        db.add_column(u'mrbelvedere_pullrequest', 'head_sha',
                      self.gf('django.db.models.fields.CharField')(default='default_value', max_length=32),
                      keep_default=False)

        # Adding field 'PullRequest.base_sha'
        db.add_column(u'mrbelvedere_pullrequest', 'base_sha',
                      self.gf('django.db.models.fields.CharField')(default='default_value', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PullRequest.head_sha'
        db.delete_column(u'mrbelvedere_pullrequest', 'head_sha')

        # Deleting field 'PullRequest.base_sha'
        db.delete_column(u'mrbelvedere_pullrequest', 'base_sha')
