...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RepositoryNewBranchJob.prefix'
        db.add_column(u'mrbelvedere_repositorynewbranchjob', 'prefix',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RepositoryNewBranchJob.prefix'
        db.delete_column(u'mrbelvedere_repositorynewbranchjob', 'prefix')
