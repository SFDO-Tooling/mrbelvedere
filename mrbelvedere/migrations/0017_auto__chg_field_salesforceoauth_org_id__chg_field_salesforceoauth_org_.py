...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SalesforceOAuth.org_id'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'org_id', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SalesforceOAuth.org_type'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'org_type', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SalesforceOAuth.signature'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'signature', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SalesforceOAuth.issued_at'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'issued_at', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SalesforceOAuth.scope'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'scope', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SalesforceOAuth.refresh_token'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'refresh_token', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'SalesforceOAuth.org_id'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'org_id', self.gf('django.db.models.fields.CharField')(max_length=24))

        # Changing field 'SalesforceOAuth.org_type'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'org_type', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'SalesforceOAuth.signature'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'signature', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'SalesforceOAuth.issued_at'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'issued_at', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'SalesforceOAuth.scope'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'scope', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'SalesforceOAuth.refresh_token'
        db.alter_column(u'mrbelvedere_salesforceoauth', 'refresh_token', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        u'mrbelvedere.packagebuilderbuild': {
            ...
            'builder': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'builds'", 'to': u"orm['mrbelvedere.PackageBuilder']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'install_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'mrbelvedere.salesforceoauth': {
            ...
            'issued_at': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'oauth_id': ('django.db.models.fields.URLField', [], {'max_length': '200'}),
            'org_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
