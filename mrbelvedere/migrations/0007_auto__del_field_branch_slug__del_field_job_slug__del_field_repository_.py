...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Branch.slug'
        db.delete_column(u'mrbelvedere_branch', 'slug')

        # Deleting field 'Job.slug'
        db.delete_column(u'mrbelvedere_job', 'slug')

        # Deleting field 'Repository.slug'
        db.delete_column(u'mrbelvedere_repository', 'slug')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Branch.slug'
        raise RuntimeError("Cannot reverse this migration. 'Branch.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Branch.slug'
        db.add_column(u'mrbelvedere_branch', 'slug',
        ...
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Job.slug'
        db.add_column(u'mrbelvedere_job', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Repository.slug'
        raise RuntimeError("Cannot reverse this migration. 'Repository.slug' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Repository.slug'
        db.add_column(u'mrbelvedere_repository', 'slug',
                      self.gf('django.db.models.fields.SlugField')(max_length=50),
                      keep_default=False)
