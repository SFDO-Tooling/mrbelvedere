...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PullRequest.last_build_base_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'last_build_base_sha', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

        # Changing field 'PullRequest.base_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'base_sha', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'PullRequest.head_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'head_sha', self.gf('django.db.models.fields.CharField')(max_length=64))

        # Changing field 'PullRequest.last_build_head_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'last_build_head_sha', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))

    def backwards(self, orm):

        # Changing field 'PullRequest.last_build_base_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'last_build_base_sha', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))

        # Changing field 'PullRequest.base_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'base_sha', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'PullRequest.head_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'head_sha', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'PullRequest.last_build_head_sha'
        db.alter_column(u'mrbelvedere_pullrequest', 'last_build_head_sha', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
