...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageBuilderBuild.install_url'
        db.add_column(u'mrbelvedere_packagebuilderbuild', 'install_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


        # Changing field 'PackageBuilderBuild.version'
        db.alter_column(u'mrbelvedere_packagebuilderbuild', 'version', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'PackageBuilderBuild.install_url'
        db.delete_column(u'mrbelvedere_packagebuilderbuild', 'install_url')


        # User chose to not deal with backwards NULL issues for 'PackageBuilderBuild.version'
        raise RuntimeError("Cannot reverse this migration. 'PackageBuilderBuild.version' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'PackageBuilderBuild.version'
        db.alter_column(u'mrbelvedere_packagebuilderbuild', 'version', self.gf('django.db.models.fields.CharField')(max_length=255))
