...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PullRequest.state'
        db.add_column(u'mrbelvedere_pullrequest', 'state',
                      self.gf('django.db.models.fields.CharField')(default='open', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PullRequest.state'
        db.delete_column(u'mrbelvedere_pullrequest', 'state')
