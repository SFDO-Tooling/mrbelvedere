...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Package.namespace'
        db.alter_column(u'mpinstaller_package', 'namespace', self.gf('django.db.models.fields.SlugField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'Package.namespace'
        db.alter_column(u'mpinstaller_package', 'namespace', self.gf('django.db.models.fields.SlugField')(max_length=50))
