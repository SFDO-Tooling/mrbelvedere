...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageInstallation.fork'
        db.add_column(u'mpinstaller_packageinstallation', 'fork',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageInstallation.fork'
        db.delete_column(u'mpinstaller_packageinstallation', 'fork')
    ...
    models = {
        ...
        u'mpinstaller.packageinstallation': {
            ...
            'fork': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
