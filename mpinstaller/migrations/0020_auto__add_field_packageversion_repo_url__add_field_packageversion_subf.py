...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.repo_url'
        db.add_column(u'mpinstaller_packageversion', 'repo_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageVersion.subfolder'
        db.add_column(u'mpinstaller_packageversion', 'subfolder',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.repo_url'
        db.delete_column(u'mpinstaller_packageversion', 'repo_url')

        # Deleting field 'PackageVersion.subfolder'
        db.delete_column(u'mpinstaller_packageversion', 'subfolder')
