...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackageInstallation.fork'
        db.alter_column(u'mpinstaller_packageinstallation', 'fork', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'PackageInstallation.git_ref'
        db.alter_column(u'mpinstaller_packageinstallation', 'git_ref', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'PackageInstallation.fork'
        db.alter_column(u'mpinstaller_packageinstallation', 'fork', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'PackageInstallation.git_ref'
        db.alter_column(u'mpinstaller_packageinstallation', 'git_ref', self.gf('django.db.models.fields.TextField')(null=True))
