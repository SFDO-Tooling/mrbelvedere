...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PackageVersion.content_intro'
        db.add_column(u'mpinstaller_packageversion', 'content_intro',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PackageVersion.content_intro'
        db.delete_column(u'mpinstaller_packageversion', 'content_intro')
