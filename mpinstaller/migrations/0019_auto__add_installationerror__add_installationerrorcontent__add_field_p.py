...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InstallationError'
        db.create_table(u'mpinstaller_installationerror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='errors', null=True, to=orm['mpinstaller.InstallationErrorContent'])),
            ('fallback_content', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='errors_fallback', null=True, to=orm['mpinstaller.InstallationErrorContent'])),
            ('hide_from_report', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'mpinstaller', ['InstallationError'])

        # Adding model 'InstallationErrorContent'
        db.create_table(u'mpinstaller_installationerrorcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resolution', self.gf('tinymce.models.HTMLField')()),
        ))
        db.send_create_signal(u'mpinstaller', ['InstallationErrorContent'])

        # Adding field 'PackageInstallationStep.error'
        db.add_column(u'mpinstaller_packageinstallationstep', 'error',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mpinstaller.InstallationError'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'InstallationError'
        db.delete_table(u'mpinstaller_installationerror')

        # Deleting model 'InstallationErrorContent'
        db.delete_table(u'mpinstaller_installationerrorcontent')

        # Deleting field 'PackageInstallationStep.error'
        db.delete_column(u'mpinstaller_packageinstallationstep', 'error_id')
    ...
    models = {
        ...
        u'mpinstaller.packageinstallationstep': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'error': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mpinstaller.InstallationError']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
