...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.content_intro_beta'
        db.add_column(u'mpinstaller_package', 'content_intro_beta',
                      self.gf('tinymce.models.HTMLField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.content_intro_beta'
        db.delete_column(u'mpinstaller_package', 'content_intro_beta')
