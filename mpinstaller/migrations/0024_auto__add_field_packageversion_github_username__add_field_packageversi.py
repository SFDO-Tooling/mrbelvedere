...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.github_username'
        db.add_column(u'mpinstaller_packageversion', 'github_username',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageVersion.github_password'
        db.add_column(u'mpinstaller_packageversion', 'github_password',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.github_username'
        db.delete_column(u'mpinstaller_packageversion', 'github_username')

        # Deleting field 'PackageVersion.github_password'
        db.delete_column(u'mpinstaller_packageversion', 'github_password')
    ...
    models = {
        ...
        u'mpinstaller.packageinstallation': {
            ...
            'git_ref': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
