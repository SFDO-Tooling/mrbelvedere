...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackageInstallation.install_hash'
        db.alter_column(u'mpinstaller_packageinstallation', 'install_hash', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):

        # Changing field 'PackageInstallation.install_hash'
        db.alter_column(u'mpinstaller_packageinstallation', 'install_hash', self.gf('django.db.models.fields.CharField')(max_length=64))
    ...
    models = {
        ...
        u'mpinstaller.packageinstallation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'install_hash': ('django.db.models.fields.CharField', [], {'default': "'a67a71441cf5f26f1a4c73a033e03352cd442cd0a630f108ab3afaec65ad469d28489774463a05bad3931753c9ad2336b060753ea9e5222e67ffeb9398d94945'", 'max_length': '128'}),
