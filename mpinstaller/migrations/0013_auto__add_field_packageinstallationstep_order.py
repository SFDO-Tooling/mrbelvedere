...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageInstallationStep.order'
        db.add_column(u'mpinstaller_packageinstallationstep', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageInstallationStep.order'
        db.delete_column(u'mpinstaller_packageinstallationstep', 'order')
