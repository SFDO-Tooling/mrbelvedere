...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.namespace_token'
        db.add_column(u'mpinstaller_packageversion', 'namespace_token',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'PackageVersion.namespace'
        db.add_column(u'mpinstaller_packageversion', 'namespace',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.namespace_token'
        db.delete_column(u'mpinstaller_packageversion', 'namespace_token')

        # Deleting field 'PackageVersion.namespace'
        db.delete_column(u'mpinstaller_packageversion', 'namespace')
