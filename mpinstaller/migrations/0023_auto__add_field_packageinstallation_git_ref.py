...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageInstallation.git_ref'
        db.add_column(u'mpinstaller_packageinstallation', 'git_ref',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageInstallation.git_ref'
        db.delete_column(u'mpinstaller_packageinstallation', 'git_ref')
