...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.current_github'
        db.add_column(u'mpinstaller_package', 'current_github',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='current_github', null=True, to=orm['mpinstaller.PackageVersion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.current_github'
        db.delete_column(u'mpinstaller_package', 'current_github_id')
