...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PackageInstallationStep.package_version'
        db.delete_column(u'mpinstaller_packageinstallationstep', 'package_version_id')

        # Adding field 'PackageInstallationStep.version'
        db.add_column(u'mpinstaller_packageinstallationstep', 'version',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='installation_steps', null=True, to=orm['mpinstaller.PackageVersion']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PackageInstallationStep.package_version'
        db.add_column(u'mpinstaller_packageinstallationstep', 'package_version',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='installation_steps', null=True, to=orm['mpinstaller.PackageVersion'], blank=True),
                      keep_default=False)

        # Deleting field 'PackageInstallationStep.version'
        db.delete_column(u'mpinstaller_packageinstallationstep', 'version_id')
