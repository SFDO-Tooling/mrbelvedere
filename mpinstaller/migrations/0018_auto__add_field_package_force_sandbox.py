...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.force_sandbox'
        db.add_column(u'mpinstaller_package', 'force_sandbox',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.force_sandbox'
        db.delete_column(u'mpinstaller_package', 'force_sandbox')
