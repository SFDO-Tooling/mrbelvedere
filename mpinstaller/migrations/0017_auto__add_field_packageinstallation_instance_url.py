...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageInstallation.instance_url'
        db.add_column(u'mpinstaller_packageinstallation', 'instance_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageInstallation.instance_url'
        db.delete_column(u'mpinstaller_packageinstallation', 'instance_url')
