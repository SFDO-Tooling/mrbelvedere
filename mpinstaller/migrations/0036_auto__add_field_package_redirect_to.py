...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.redirect_to'
        db.add_column(u'mpinstaller_package', 'redirect_to',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.redirect_to'
        db.delete_column(u'mpinstaller_package', 'redirect_to')
    ...
    models = {
        ...
        u'mpinstaller.packageinstallation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'install_hash': ('django.db.models.fields.CharField', [], {'default': "'41f8b157e01b17110e5c13539cf1b53f76a5f391507504aa6072a3d11a1947ed7910de9d6f55806e48875520f010d510c7e3d6e0478421ea25a91e180fc314ab'", 'unique': 'True', 'max_length': '128'}),
