...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageVersion.branch'
        db.add_column(u'mpinstaller_packageversion', 'branch',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PackageVersion.branch'
        db.delete_column(u'mpinstaller_packageversion', 'branch')
