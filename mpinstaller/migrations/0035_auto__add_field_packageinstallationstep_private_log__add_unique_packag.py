...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PackageInstallationStep.private_log'
        db.add_column(u'mpinstaller_packageinstallationstep', 'private_log',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'PackageInstallation', fields ['install_hash']
        db.create_unique(u'mpinstaller_packageinstallation', ['install_hash'])


    def backwards(self, orm):
        # Removing unique constraint on 'PackageInstallation', fields ['install_hash']
        db.delete_unique(u'mpinstaller_packageinstallation', ['install_hash'])

        # Deleting field 'PackageInstallationStep.private_log'
        db.delete_column(u'mpinstaller_packageinstallationstep', 'private_log')
    ...
    models = {
        ...
        u'mpinstaller.packageinstallation': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'install_hash': ('django.db.models.fields.CharField', [], {'default': "'277a3936181011c06f9402791c4a2bbb5107b00b2e87ccaf79bdab91b226d3546d2e0d28feb8a5e5d81c33518544c6707ab6be0604a3e81b946142a4f99ee2b0'", 'unique': 'True', 'max_length': '128'}),
        ...
        u'mpinstaller.packageinstallationstep': {
            ...
            'private_log': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
