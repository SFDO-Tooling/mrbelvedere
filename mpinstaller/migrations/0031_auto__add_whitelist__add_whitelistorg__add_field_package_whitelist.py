...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mpinstaller_whitelist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'mpinstaller', ['WhiteList'])

        # Adding model 'WhiteListOrg'
        db.create_table(u'mpinstaller_whitelistorg', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('whitelist', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orgs', to=orm['mpinstaller.WhiteList'])),
            ('org_id', self.gf('django.db.models.fields.CharField')(max_length=18)),
        ))
        db.send_create_signal(u'mpinstaller', ['WhiteListOrg'])

        # Adding field 'Package.whitelist'
        db.add_column(u'mpinstaller_package', 'whitelist',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='packages', null=True, to=orm['mpinstaller.WhiteList']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'WhiteList'
        db.delete_table(u'mpinstaller_whitelist')

        # Deleting model 'WhiteListOrg'
        db.delete_table(u'mpinstaller_whitelistorg')

        # Deleting field 'Package.whitelist'
        db.delete_column(u'mpinstaller_package', 'whitelist_id')
