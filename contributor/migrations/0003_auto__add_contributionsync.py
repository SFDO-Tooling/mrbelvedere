...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContributionSync'
        db.create_table(u'contributor_contributionsync', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contribution', self.gf('django.db.models.fields.related.ForeignKey')(related_name='syncs', to=orm['contributor.Contribution'])),
            ...
            ('new_commit', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('new_installation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contribution_syncs', null=True, to=orm['mpinstaller.PackageInstallation'])),
            ('pre_state_behind_main', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pre_state_undeployed_commit', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pre_state_uncommitted_changes', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('post_state_behind_main', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('post_state_undeployed_commit', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('post_state_uncommitted_changes', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_started', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'contributor', ['ContributionSync'])


    def backwards(self, orm):
        # Deleting model 'ContributionSync'
        db.delete_table(u'contributor_contributionsync')
