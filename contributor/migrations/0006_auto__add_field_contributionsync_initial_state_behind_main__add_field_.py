...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ContributionSync.initial_state_behind_main'
        db.add_column(u'contributor_contributionsync', 'initial_state_behind_main',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ContributionSync.initial_state_undeployed_commit'
        db.add_column(u'contributor_contributionsync', 'initial_state_undeployed_commit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ContributionSync.initial_state_uncommitted_changes'
        db.add_column(u'contributor_contributionsync', 'initial_state_uncommitted_changes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ContributionSync.initial_state_behind_main'
        db.delete_column(u'contributor_contributionsync', 'initial_state_behind_main')

        # Deleting field 'ContributionSync.initial_state_undeployed_commit'
        db.delete_column(u'contributor_contributionsync', 'initial_state_undeployed_commit')

        # Deleting field 'ContributionSync.initial_state_uncommitted_changes'
        db.delete_column(u'contributor_contributionsync', 'initial_state_uncommitted_changes')
    ...
    models = {
        ...
        u'contributor.contributionsync': {
            ...
            'date_started': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_state_behind_main': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'initial_state_uncommitted_changes': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'initial_state_undeployed_commit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
