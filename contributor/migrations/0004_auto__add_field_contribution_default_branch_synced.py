...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.default_branch_synced'
        db.add_column(u'contributor_contribution', 'default_branch_synced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.default_branch_synced'
        db.delete_column(u'contributor_contribution', 'default_branch_synced')
