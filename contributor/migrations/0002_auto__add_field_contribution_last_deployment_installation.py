...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.last_deployment_installation'
        db.add_column(u'contributor_contribution', 'last_deployment_installation',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contributions', null=True, to=orm['mpinstaller.PackageInstallation']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.last_deployment_installation'
        db.delete_column(u'contributor_contribution', 'last_deployment_installation_id')
